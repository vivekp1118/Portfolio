...
function Message() {
  ...
  const [interactionActive, setInteractionActive] = useState(
  ...
  const getRandomEmoji = () => {
    ...
    console.log(emojisArray[randomNum]);
    setCurrentEmoji({
      emoji: emojisArray[randomNum],
      ...colorsArray[anotherRandomNum],
    });
  };
  ...
  return (
    <div className="page message-container">
      <div className="message-info">
        <h1 className="menu-page-header">Message form the Creator</h1>
        <h2 className="thank-you-message">
          <span className="text-saperator">Hmm, Thank You.</span>
          <span className="text-saperator">
            Who ever is Viewing this, I hope you have a great day! <br />
          </span>
          <span className="text-saperator">
            Thank you for coming so far and exporing my Work It means lot to me,
      ...
      {interactionActive && (
        ...
        >
          {currentEmoji.emoji === "?" ? (
            ...
            <img src={currentEmoji.emoji} style={{width:"100%",height:"100%"}}></img>
          )}
        </div>
      )}
      ...
      <PageScroller />
      <div
        className="interaction-activate-btn-mobile"
